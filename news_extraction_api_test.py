...
class sentence_summarization_test(unittest.TestCase):
    ...
    def test_separate_text(self):
        ...
        sent = news_extraction_api.separate_text_h1(text)
        log.info(type(sent))
    ...
    def test_paragraph_delineation(self):
        text = "My dog is very furry and is a putrid green color that looks like somebody threw up on him. My cat is very smart and is a interesting red color that looks like somebody threw up on him."
